...
public class BookCriteria implements Serializable, Criteria {
    ...
    public BookCriteria(BookCriteria other) {
        ...
        this.bookGenreId = other.bookGenreId == null ? null : other.bookGenreId.copy();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, releaseDate, bookGenreId, publisherId, authorId, distinct);
    }
    ...
    public String toString() {
        return "BookCriteria{" +
            ...
            (bookGenreId != null ? "bookGenreId=" + bookGenreId + ", " : "") +
